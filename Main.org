...
*** Surrogate Residuals
    ...
    function from OGAM models fitted with =mgcv=.
...
**** Text 1                                  :noheading:
     ...
     Enxplain the number of the abstract, the empirical formula RM,
     Annex 1B.
...
**** Text 1                                  :noheading:
    ...
    Les communes transmettaient beaucoup plus d'information à la mise
    en place des AOC, du coup il faudra faire le tableau pour le
    mettre en annexe ou alors on peut le voir de la première colonne
    du tableau.
...
**** Text 2                                  :noheading:
     ...
     attributes. Expliain why only horizontal residual change in
     simultations.
