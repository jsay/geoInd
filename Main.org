...
*** The Informational Content of Geographical Indications
    ...
    R code and Shiny application to predict vineyard quality from the
    geographical indications of /Côte d'Or/ (Burgundy, France).
    Relating the fine-scale biophysical attributes to the hierarchical
    scheme of /Appellations d'Origine Contrôlée/ allows to predict a
    continuous quality score for each of the 60000 vineyards plots of
    the area.  The Figure below reports the distribution according to
    the actual classification and a correction of the unequal
