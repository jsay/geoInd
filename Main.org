...
No XXX.  The data used are under licence Creative Commons, available
on the INRA dataverse website: https://data.inra.fr.  R functions used
are reported in the appendix to preserve the visibility of codes.
Additional elements are in the French version available from the
